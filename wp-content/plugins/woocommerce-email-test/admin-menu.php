...
?>
    <div class="wrap">
        ...
        <h2 class="nav-tab-wrapper">
            ...
            <a href="?page=woocommerce-email-test&tab=monitor" class="nav-tab <?php echo $tab == 'monitor' ? 'nav-tab-active' : ''; ?>">Email Monitor</a>
        </h2>       
        ...
        <?php if( $tab == 'monitor' ){ ?>
            ...
            <h2>Email Uptime Monitor</h2>
            
            <p>Sleep soundly, knowing that your WooCommerce transactional emails are running smoothly.</p>

            <p>Around the clock transactional email monitoring for WooCommerce.</p>

            <a href="https://ecomemailmonitor.co.uk/wordpress/woocommerce-email-monitor" class="button button-primary" target="_blank">Find Out More ></a>
